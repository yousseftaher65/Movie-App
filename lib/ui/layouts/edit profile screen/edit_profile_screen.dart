...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  @override
  void initState() {
    nameController.text = BlocProvider.of<EditProfileCubit>(context).userModel!.name ?? '';
    currentIndex = BlocProvider.of<EditProfileCubit>(context).userModel!.imageIndex ?? 0;
    super.initState();
  }
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      bloc.updateDataUser(model: model, userId: model.id);
                    },
                    child: Text(
                      'update_data'.tr(),
                      style:
